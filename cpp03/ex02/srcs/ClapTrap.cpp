...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		std::cout << YELLOW "ClapTrap " << this->_name << " can't be repaired, he has no energy left" RESET
				  << std::endl;
	}
	return ;
}
...
void ClapTrap::attack(const std::string &target)
{
	...
	{
		std::cout << YELLOW "ClapTrap " << this->_name << " cant't attack, he has no energy left" RESET
				  << std::endl;
	}
